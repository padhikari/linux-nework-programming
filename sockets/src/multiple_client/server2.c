...
//call waitpid() for any exited children and call waitpid() for each one
...
int main(int argc, char *argv[])
{
    ...
    //create the socket that accept the incoming connections
	...
	//before start looping, install signal handler
